        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="relative aspect-[4/3] rounded-2xl bg-slate-100 overflow-hidden">
              <div className="absolute inset-0 flex items-center justify-center bg-slate-800/90 text-slate-400">
                <div className="text-center p-6">
                  ...
                  <p className="text-sm font-medium">Team / Job Site Photo</p>
                  <p className="mt-1 text-xs text-slate-500">
                    Add image: public/images/about-team.jpg
                  </p>
                </div>
              </div>
            </div>
